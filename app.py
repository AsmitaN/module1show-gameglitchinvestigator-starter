...
# FIX: Added logic that checks if the difficulty was switched using agent mode
...
# FIX: Adjusted guess range display on page based on difficulty using agent mode
st.info(
    f"Guess a number between 1 and "
    f"{high}. "
